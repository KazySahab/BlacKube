...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void Update()
    {
       ...
       if (playerInput.Move > 0 ) transform.localScale = Vector3.one;
       else if (playerInput.Move < 0 ) transform.localScale = new Vector3(-1, 1, 1);
    ...
    private void FixedUpdate()
    {
        ...
        rb.velocity = new Vector2(playerInput.Move * speed * Time.fixedDeltaTime, rb.velocity.y);
    }
